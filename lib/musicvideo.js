...
module.exports = class {
  ...
  constructor(LightLeak, audio, params) {
    this._audioAnalyser = new Audio.Analyser(
      audio.fftSize,
      audio.sampleRate
    );
    ...
    this._root = new Root(params, LightLeak, this._audioAnalyser, this.renderer);
  }

  destroy() {
    this.renderer.destroy();
    this._root.displayObject.destroy({ children: true });
  }
  ...
  update(time, floatFrequencyData) {
    this._audioAnalyser.update(floatFrequencyData);
