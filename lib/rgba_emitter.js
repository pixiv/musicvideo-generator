...
function createOfflineAnalyserNode(buffer) {
  /*
   * The number of channels and the sample rate must be equal to the
   * counterparts of the online playback. These values are used in *most*
   * online playback environments though that is not guranteed.
   */
